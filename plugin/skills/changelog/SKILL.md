---
name: changelog
description: Generate deterministic end-user changelogs locally or configure the Spare Parts Changelog GitHub Action, with separately consented optional S3 and LinkedIn publishers.
---
...
2. For local generation, invoke the shipped `spareparts-changelog generate` command. Never compose or rewrite the changelog in the prompt.
